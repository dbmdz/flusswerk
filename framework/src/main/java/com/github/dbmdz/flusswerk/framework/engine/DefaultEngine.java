...
public class DefaultEngine implements Engine {
  ...
  public DefaultEngine(
      Channel channel, List<FlusswerkConsumer> flusswerkConsumers, List<Worker> workers) {
  ...
  public EngineStats getStats() {
    // FIXME does not make sense anymore, at least not this way
    return new EngineStats(workers.size(), workers.size(), 0);
  }
}
